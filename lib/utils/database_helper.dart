...
class DatabaseHelper {
  ...
  Future<List<Map<String, dynamic>>> getChapterMapList(int bookNumber) async {
    Database db = await this.database;
    var query =
        'SELECT DISTINCT chapter FROM "verses" WHERE book_number = $bookNumber';
  ...
  Future<List<Map<String, dynamic>>> getTextMapList(
      String bookNumber, int chapter) async {
    Database db = await this.database;
    var query =
        'SELECT text FROM "verses" WHERE chapter = $chapter AND book_number = $bookNumber';
    return await db.rawQuery(query);
  }
  ...
  Future<List<Map<String, dynamic>>> getResultsMap(String query) async {
    Database db = await this.database;
    var sqlQuery =
        'SELECT book_number, chapter, verse, `text` FROM verses WHERE `text` LIKE "%$query%"';
